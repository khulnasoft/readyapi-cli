...
def test_package_app_root(capsys: CaptureFixture[str]) -> None:
    ...
    assert "readyapi-cli/tests/assets/package/mod/app.py" in captured.out
    assert (
        "Searching for package file structure from directories with __init__.py files"
        in captured.out
    )
    assert "Importing from" in captured.out
    assert "readyapi-cli/tests/assets" in captured.out
...
def test_package_api_root(capsys: CaptureFixture[str]) -> None:
    ...
    assert "Resolved absolute path" in captured.out
    assert "readyapi-cli/tests/assets/package/mod/api.py" in captured.out
    assert (
        "Searching for package file structure from directories with __init__.py files"
        in captured.out
    )
...
def test_package_other_root(capsys: CaptureFixture[str]) -> None:
    ...
    assert "Resolved absolute path" in captured.out
    assert "readyapi-cli/tests/assets/package/mod/other.py" in captured.out
    assert (
        "Searching for package file structure from directories with __init__.py files"
        in captured.out
    )
...
def test_package_mod_init_inside(capsys: CaptureFixture[str]) -> None:
    ...
    assert "Resolved absolute path" in captured.out
    assert "readyapi-cli/tests/assets/package/mod/__init__.py" in captured.out
    assert (
        "Searching for package file structure from directories with __init__.py files"
        in captured.out
    )
...
def test_package_mod_dir(capsys: CaptureFixture[str]) -> None:
    ...
    assert "Resolved absolute path" in captured.out
    assert "readyapi-cli/tests/assets/package/mod" in captured.out
    assert (
        "Searching for package file structure from directories with __init__.py files"
        in captured.out
    )
...
def test_package_init_inside(capsys: CaptureFixture[str]) -> None:
    ...
    assert "Using path __init__.py" in captured.out
    assert "Resolved absolute path" in captured.out
    assert "readyapi-cli/tests/assets/package/__init__.py" in captured.out
    assert (
        "Searching for package file structure from directories with __init__.py files"
        in captured.out
    )
...
def test_package_dir_inside_package(capsys: CaptureFixture[str]) -> None:
    ...
    assert "Resolved absolute path" in captured.out
    assert "readyapi-cli/tests/assets/package" in captured.out
    assert (
        "Searching for package file structure from directories with __init__.py files"
        in captured.out
    )
